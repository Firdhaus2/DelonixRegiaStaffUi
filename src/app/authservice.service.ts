...
export class AuthserviceService {
  ...
  regStaffUser(staffAccountNumber:string, username: string, password: string, role: string) {
    return this.http.get('/api/regstaffuser/' + staffAccountNumber + '/' + username + "/" + password + "/"  + role);
  }
}
